...
* [[Issue #70](https://github.com/basho/riak_ensemble/issues/70)/[PR #75](https://github.com/basho/riak_ensemble/pull/75)] - Some clusters unable to start ensembles due to a block on ensemble peers within the leveldb synctree. Now leveldb synctree lock behavior is limited to local node.
...
* [[Issue #469](https://github.com/basho/yokozuna/pull/469)/[PR #470](https://github.com/basho/yokozuna/pull/470)] - Fix YZ stats name typo from throughput to throughput.
...
* Enhance LeveldDB write throttle to support single vnode loads (such as handoff) and other minor adjustments. [[PR #146](https://github.com/basho/leveldb/pull/146)]
