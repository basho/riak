...
** How to Report a Bug or Contribute Code

  - Please open a [[new issue][https://github.com/basho/riak/issues]] against this repository to report bugs, issues, or to submit a pull request.
  - You can read the [[full guidelines][http://docs.basho.com/riak/latest/references/appendices/community/How-to-Report-a-Bug/]] on the Riak Docs. 
