...
%% </pre>
%%
%% Register for all events generated by the riak_kv_vnode module:
%% <pre>
%% RiakClient:add_event_handler(self(), "Description", {riak_kv_vnode, '_', '_', '_'}, []))
%% </pre>
%% 
%% Register for all 'put', 'get', and 'delete' events generated by the riak_kv_vnode module:
%% <pre>
%% MatchHead = {'$1', '$2', '_', '_'},
%% MatchGuard = [
%%   {'andalso', {'==', '$1', riak_kv_vnode}, {'orelse', {'==', '$2', get}, {'==', '$2', put}, {'==', '$2', delete}}}
%% ],
...
add_handler_to_ring_test() ->
    ...
    % Add another handler...
    Handler2 = make_handler(self(), "Test description 1", {riak_kv_vnode, '_', '_', '_'}, []),
...
get_matching_handlers_test() ->
    Handlers = [
        ...
        make_handler(self(),"Only riak_kv_vnode 1", {riak_kv_vnode, '_', '_', '_'}, []),
        make_handler(self(),"Only riak_kv_vnode 2", {'$1', '_', '_', '_'}, [{'==', '$1', riak_kv_vnode}]),
        make_handler(self(),"Only riak_kv_vnode delete", {riak_kv_vnode, delete, '_', '_'}, []),
        make_handler(self(),"Only riak_kv_vnode put, get, or delete", {'$1', '$2', '_', '_'}, [
            {'andalso', {'==', '$1', riak_kv_vnode}, {'orelse', {'==', '$2', get}, {'==', '$2', put}, {'==', '$2', delete}}}
        ])
    ],
    ?assert(length(get_matching_handlers({test, ignored, ignored, ignored}, Handlers)) == 2),    
    ?assert(length(get_matching_handlers({riak_kv_vnode, ignored, ignored, ignored}, Handlers)) == 4),    
    ?assert(length(get_matching_handlers({riak_kv_vnode, delete, ignored, ignored}, Handlers)) == 6).
